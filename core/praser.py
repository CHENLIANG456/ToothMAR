...
def init_obj(opt, logger, *args, default_file_name='default file', given_module=None, init_type='Network',
    ...
    try:
        ...
        if isinstance(attr, type):
            ret = attr(*args, **kwargs)  # init the class
            ret.__name__ = ret.__class__.__name__  # set the name of the class
        elif isinstance(attr, FunctionType):
            ret = partial(attr, *args, **kwargs)  # init the function，partial function: bind args and kwargs
            ret.__name__ = attr.__name__  # set the name of the function
            # ret = attr
